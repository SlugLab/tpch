...
perf stat record -F 60000 --all-user mserver5 --dbpath=/home/victoryang00/bak/$5/$5 --set monet_vault_key=/home/victoryang00/bak/$5/$5/.vaultkey &
# pid2=$!
    ...
    while true; do
        ...
        if ! ps -p $pid >/dev/null; then
            if [[ $count == 1 ]]; then
                ...
                sleep 20
                perf stat report -NN -c pid,iaddr --full-symbols --stdio >$5-$6-c2c-stat.txt
                sleep 10
